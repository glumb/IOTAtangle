    ...
    })(
        {
            1: [
                function(require, module, exports) {
                    ...
                    var Viva = {
                        lazyExtend: function() {
                            return require('ngraph.merge').apply(
                                this,
                                arguments
                            )
                        },
                        randomIterator: function() {
                            return random.randomIterator.apply(
                                random,
                                arguments
                            )
                        },
                    ...
                    Viva.Graph = {
                        ...
                        View: {
                            ...
                            cssGraphics: function() {
                                throw new Error(
                                    'cssGraphics is deprecated. Please use older version of vivagraph (< 0.7) if you need it'
                                )
                            },

                            svgNodeFactory: function() {
                                throw new Error(
                                    'svgNodeFactory is deprecated. Please use older version of vivagraph (< 0.7) if you need it'
                                )
                            },

                            community: function() {
                                throw new Error(
                                    'community is deprecated. Please use vivagraph < 0.7 if you need it, or `https://github.com/anvaka/ngraph.slpa` module'
                                )
                            }
                        },
            ...
            3: [
                function(require, module, exports) {
                    ...
                    function intersect(
                        ...
                        y1,
                        x2,
                        y2, // first line segment
                        x3,
                        y3,
                        x4,
                        y4 // second line segment
                    ) {
                        var a1,
                            a2,
                            b1,
                        ...
                        num = b1 * c2 - b2 * c1
                        result.x =
                            (num < 0 ? num - offset : num + offset) / denom
                ...
                function(require, module, exports) {
                    ...
                    function degree(graph, kind) {
                        ...
                        if (kind === 'both' || kind === 'inout') {
                            ...
                            throw new Error(
                                'Expected centrality degree kind is: in, out or both'
                            )
                        }
            ...
            9: [
                function(require, module, exports) {
                    ...
                    function createLayout(graph, physicsSettings) {
                        ...
                        var springTransform =
                            physicsSimulator.settings.springTransform || noop
                        ...
                        function initBody(nodeId, position) {
                            ...
                            if (!body) {
                                ...
                                if (!pos) {
                                    ...
                                    pos = physicsSimulator.getBestNewBodyPosition(
                                        neighbors
                                    )
                                }
                        ...
                        function initLink(link) {
                            ...
                            var fromBody = nodeBodies[link.fromId],
                                ...
                                spring = physicsSimulator.addSpring(
                                    fromBody,
                                    toBody,
                                    link.length
                                )
                        ...
                        function getNeighborBodies(node) {
                            ...
                            for (var i = 0; i < maxNeighbors; ++i) {
                                ...
                                var otherBody =
                                    link.fromId !== node.id
                                        ? nodeBodies[link.fromId]
                                        : nodeBodies[link.toId]
            ...
            10: [
                function(require, module, exports) {
                    ...
                    function load(jsonGraph, nodeTransform, linkTransform) {
                        ...
                        if (
                            stored.links === undefined ||
                            stored.nodes === undefined
                        ) {
                            throw new Error(
                                'Cannot load graph without links and nodes'
                            )
                        }
                        ...
                        for (i = 0; i < stored.nodes.length; ++i) {
                            ...
                            if (!parsedNode.hasOwnProperty('id')) {
                                throw new Error(
                                    'Graph node format is invalid: Node id is missing'
                                )
                            }
                        ...
                        for (i = 0; i < stored.links.length; ++i) {
                            ...
                            if (
                                !link.hasOwnProperty('fromId') ||
                                !link.hasOwnProperty('toId')
                            ) {
                                throw new Error(
            ...
            11: [
                function(require, module, exports) {
                    ...
                    function complete(n) {
                        ...
                        if (!n || n < 1) {
                            throw new Error(
                                'At least two nodes are expected for complete graph'
                            )
                        }
                    ...
                    function completeBipartite(n, m) {
                        ...
                        if (!n || !m || n < 0 || m < 0) {
                            throw new Error(
                                'Graph dimensions are invalid. Number of nodes in each partition should be greater than 0'
                            )
                        }
                    ...
                    function grid(n, m) {
                        ...
                        if (n < 1 || m < 1) {
                            throw new Error(
                                'Invalid number of nodes in grid graph'
                            )
                        }
                        var g = createGraph(),
                            i,
                    ...
                    function grid3(n, m, z) {
                        ...
                        if (n < 1 || m < 1 || z < 1) {
                            throw new Error(
                                'Invalid number of nodes in grid3 graph'
                            )
                        }
                        var g = createGraph(),
                            i,
                    ...
                    function balancedBinTree(n) {
                        ...
                        if (n < 0) {
                            throw new Error(
                                'Invalid number of nodes in balanced tree'
                            )
                        }
                        var g = createGraph(),
                            count = Math.pow(2, n),
 ...
 */
                        if (k >= n)
                            throw new Error(
                                'Choose smaller `k`. It cannot be larger than number of nodes `n`'
                            )
                        ...
                        for (j = 1; j < neighborsSize; ++j) {
                            for (i = 0; i < n; ++i) {
                                if (random.nextDouble() < p) {
                                    ...
                                    var needsRewire =
                                        newTo === from || g.hasLink(from, newTo)
                                    if (
                                        needsRewire &&
                                        g.getLinks(from).length === n - 1
                                    ) {
                ...
                function(require, module, exports) {
                    ...
                    function createGraph(options) {
                        ...
                        var nodes =
                            ...
                            createLink = options.uniqueLinkId
                                ? createUniqueLink
                                : createSingleLink,
                        ...
                        function forEachLinkedNode(nodeId, callback, oriented) {
                            ...
                            if (
                                ...
                                if (oriented) {
                                    return forEachOrientedLink(
                                        node.links,
                                        nodeId,
                                        callback
                                    )
                                } else {
                                    return forEachNonOrientedLink(
                                        node.links,
                                        nodeId,
                                        callback
                                    )
                        ...
                        function forEachNonOrientedLink(
                            links,
                            nodeId,
                            callback
                        ) {
                        ...
                        if (options) {
                            for (key in options) {
                                if (options.hasOwnProperty(key)) {
                                    var targetHasIt = target.hasOwnProperty(
                                            key
                                        ),
            ...
            15: [
                function(require, module, exports) {
                    ...
                    function physicsSimulator(settings) {
                        ...
                        var createQuadTree =
                            settings.createQuadTree ||
                            require('ngraph.quadtreebh')
                        var createBounds =
                            settings.createBounds || require('./lib/bounds')
                        var createDragForce =
                            settings.createDragForce ||
                            require('./lib/dragForce')
                        var createSpringForce =
                            settings.createSpringForce ||
                            require('./lib/springForce')
                        var integrate =
                            settings.integrator ||
                            require('./lib/eulerIntegrator')
                        var createBody =
                            settings.createBody || require('./lib/createBody')
                    ...
                    module.exports = function(options) {
                        ...
                        var api = {
                            update: function(body) {
                                body.force.x -=
                                    options.dragCoeff * body.velocity.x
                                body.force.y -=
                                    options.dragCoeff * body.velocity.y
                            }
                        }
            ...
            22: [
                function(require, module, exports) {
                    ...
                    module.exports = function(options) {
                        options = options || {}
                        options.gravity =
                            typeof options.gravity === 'number'
                                ? options.gravity
                                : -1
                        options.theta =
                            typeof options.theta === 'number'
                                ? options.theta
                                : 0.8
                        options.force =
                            typeof options.force === 'object'
                                ? options.force
                                : { x: 0, y: 0 }
                        ...
                        return {
                            ...
                            options: function(newOptions) {
                                if (newOptions) {
                                    if (
                                        typeof newOptions.gravity === 'number'
                                    ) {
                        ...
                        function update(sourceBody) {
                            ...
                            sourceBody.force.x +=
                                fx +
                                force.x /
                                    (Math.abs(sourceBody.pos.x) * 0.01 + 1) //todo change
                            sourceBody.force.y +=
                                fy +
                                force.y /
                                    (Math.abs(sourceBody.pos.y) * 0.01 + 1)
                        }
                    ...
                    InsertStack.prototype = {
                        ...
                        push: function(node, body) {
                            ...
                            if (!item) {
                                ...
                                this.stack[
                                    this.popIdx
                                ] = new InsertStackElement(node, body)
                            } else {
                                item.node = node
                                item.body = body
                            }
                ...
                function(require, module, exports) {
                    ...
                    function random(inputSeed) {
                        ...
                        var randomFunc = function() {
                            ...
                            seed =
                                (seed ^ 0xc761c23c ^ (seed >>> 19)) & 0xffffffff
                            seed =
                                (seed + 0x165667b1 + (seed << 5)) & 0xffffffff
                            seed =
                                ((seed + 0xd3a2646c) ^ (seed << 9)) & 0xffffffff
                            seed =
                                (seed + 0xfd7046c5 + (seed << 3)) & 0xffffffff
                            seed =
                                (seed ^ 0xb55a4f09 ^ (seed >>> 16)) & 0xffffffff
            ...
            27: [
                function(require, module, exports) {
                    ...
                    function save(
                        ...
                        var nodeTransform =
                            customNodeTransform || defaultTransformForNode
                        var linkTransform =
                            customLinkTransform || defaultTransformForLink
                ...
                function(require, module, exports) {
                    ...
                    function augment(element) {
                        ...
                        if (typeof element === 'string') {
                            svgElement = window.document.createElementNS(
                                svgns,
                                element
                            )
                        ...
                        function link(target) {
                            ...
                            return svgElement.getAttributeNS(
                                xlinkns,
                                'xlink:href'
                            )
                        }
                ...
                function(require, module, exports) {
                    ...
                    function addNamespaces(text) {
                        ...
                        if (match) {
                            ...
                            return (
                                text.substr(0, tagLength) +
                                ' ' +
                                namespaces +
                                ' ' +
                                text.substr(tagLength)
                            )
                        } else {
                            throw new Error(
                                'Cannot parse input text: invalid xml?'
                            )
                        }
                    }
                },
            ...
            30: [
                function(require, module, exports) {
                    ...
                    function bindDomAttribute(
                        ...
                        if (!isSimpleValue)
                            throw new Error(
                                'simplesvg currently does not support nested bindings'
                            )

                        var propertyBindings = allBindings[modelPropertyName]
                        if (!propertyBindings) {
                            propertyBindings = allBindings[
                                modelPropertyName
                            ] = [attributeSetter]
                        } else {
            ...
            31: [
                function(require, module, exports) {
                    ...
                    function fail() {
                        throw new Error(
                            'DOMParser is not supported by this platform. Please open issue here https://github.com/anvaka/simplesvg'
                        )
                    }
                },
                {}
                        ...
                        var start,
                            ...
                            handleMouseWheel = function(e) {
                                ...
                                var delta,
                                    ...
                                    elementOffset = findElementPosition(
                                        element
                                    ),
                                    relMousePos = {
                            ...
                            handleTouchMove = function(e) {
                                if (e.touches.length === 1) {
                                    ...
                                    if (currentPinchLength < pinchZoomLength) {
                                        ...
                                        currentPinchLength > pinchZoomLength
                                    ) {
                                        delta = 1
                                    }
                                    scroll(e, delta, {
                            ...
                            handleTouchStart = function(e) {
                                if (e.touches.length === 1) {
                                    return handleSignleFingerTouch(
                                        e,
                                        e.touches[0]
                                    )
                                } else if (e.touches.length === 2) {
                    ...
                    function webglInputManager(graph, graphics) {
                        ...
                        inputEvents
                            ...
                            .mouseMove(function(node, e) {
                                if (draggedNode) {
                                    var handlers =
                                        internalHandlers[draggedNode.id]
                    ...
                    function constant(graph, userSettings) {
                        ...
                        return {
                            ...
                            placeNode: function(newPlaceNodeCallbackOrNode) {
                                if (
                                    typeof newPlaceNodeCallbackOrNode ===
                                    'function'
                                ) {
                                ...
                                return placeNodeCallback(
                                    newPlaceNodeCallbackOrNode
                                )
                            }
                        }
            ...
            38: [
                function(require, module, exports) {
                    ...
                    function backwardCompatibleEvents(g) {
                        console.log(
                            'This method is deprecated. Please use Viva.events() instead'
                        )
                        ...
                        function extend() {
                            ...
                            backwardCompatible.addEventListener =
                                backwardCompatible.on
                ...
                function(require, module, exports) {
                    ...
                    function getDimension(container) {
                        if (!container) {
                            throw {
                                message:
                                    'Cannot get dimensions of undefined container'
                            }
                        }
                    ...
                    ;(function(global) {
                        ...
                        function createTimer() {
                            ...
                            for (
                                ...
                                scope.requestAnimationFrame =
                                    scope[
                                        vendorPrefix + 'RequestAnimationFrame'
                                    ]
                                scope.cancelAnimationFrame =
                                    scope[
                                        vendorPrefix + 'CancelAnimationFrame'
                                    ] ||
                                    scope[
                                        vendorPrefix +
                            ...
                            function timer(callback) {
                                ...
                                function startTimer() {
                                    intervalId = scope.requestAnimationFrame(
                                        startTimer
                                    )
                                    if (!callback()) {
                                        stopTimer()
                ...
                function(require, module, exports) {
                    ...
                    function renderer(graph, settings) {
                        ...
                        function prepareSettings() {
                            ...
                            inputManager = (graphics.inputManager ||
                        ...
                        function prerender() {
                            ...
                            if (
                                typeof settings.prerender === 'number' &&
                                settings.prerender > 0
                            ) {
                                for (
                                    var i = 0;
                                    i < settings.prerender;
                                    i += 1
                                ) {
                                    layout.step()
                                }
                        ...
                        function listenToEvents() {
                            ...
                            if (isInteractive('scroll')) {
                                ...
                                containerDrag.onScroll(function(
                                    e,
                                    scaleOffset,
                                    scrollPoint
                                ) {
                    ...
                    function webglGraphics(options) {
                        ...
                        var container,
                            ...
                            updateSize = function() {
                                if (container && graphicsRoot) {
                                    width = graphicsRoot.width = Math.max(
                                        container.offsetWidth,
                                        1
                                    )
                                    height = graphicsRoot.height = Math.max(
                                    ...
                                    if (linkProgram) {
                                        linkProgram.updateSize(
                                            width / 2,
                                            height / 2
                                        )
                                    }
                                    if (nodeProgram) {
                                        nodeProgram.updateSize(
                                            width / 2,
                                            height / 2
                                        )
                                    }
                        ...
                        var graphics = {
                            ...
                            getNodeAtClientPos: function(
                                ...
                                this.transformClientToGraphCoordinates(
                                    clientPos
                                )
                    ...
                    function parseColor(color) {
                        ...
                        if (typeof color === 'string' && color) {
                            ...
                            if (color.length === 9) {
                                ...
                                // or #rrggbb.
                                parsedColor =
                                    (parseInt(color.substr(1), 16) << 8) | 0xff
                            } else {
                                throw 'Color expected in hex format with preceding "#". E.g. #00ff00. Got value: ' +
                                    color
                            }
                ...
                function(require, module, exports) {
                    ...
                    function webgl(gl) {
                        ...
                        function extendArray(
                            ...
                            if (
                                (itemsInBuffer + 1) * elementsPerItem >
                                buffer.length
                            ) {
                                // Every time we run out of space create new array twice bigger.
                                // TODO: it seems buffer size is limited. Consider using multiple arrays for huge graphs
                                var extendedArray = new Float32Array(
                                    buffer.length * elementsPerItem * 2
                                )
                        ...
                        function getLocations(
                            program,
                            uniformOrAttributeNames
                        ) {
                            var foundLocations = {}
                            for (
                                var i = 0;
                                i < uniformOrAttributeNames.length;
                                ++i
                            ) {
                                ...
                                if (name[0] === 'a' && name[1] === '_') {
                                    ...
                                    if (location === -1) {
                                        throw new Error(
                                            "Program doesn't have required attribute: " +
                                                name
                                        )
                                    }
                                    ...
                                    if (location === null) {
                                        throw new Error(
                                            "Program doesn't have required uniform: " +
                                                name
                                        )
                                    }
                                    ...
                                    throw new Error(
                                        "Couldn't figure out your intent. All uniforms should start with 'u_' prefix, and attributes with 'a_'"
                                    )
                                }
                            }
            ...
            54: [
                function(require, module, exports) {
                    ...
                    function webglAtlas(tilesPerTexture) {
                        var tilesPerRow =
                                Math.sqrt(tilesPerTexture || 1024) << 0,
                        ...
                        function remove(imgUrl) {
                            ...
                            var tileToRemove = getTileCoordinates(
                                    coordinates.offset
                                ),
                            ...
                            var replacedOffset =
                                loadedImages[trackedUrls[lastLoadedIdx]]
                            replacedOffset.offset = coordinates.offset
                            trackedUrls[coordinates.offset] =
                                trackedUrls[lastLoadedIdx]
                        ...
                        function drawAt(tileNumber, img, callback) {
                            ...
                            var currentTexture =
                                textures[tilePosition.textureNumber]

                            currentTexture.ctx.drawImage(
                                img,
                                tilePosition.col * tileSize,
                                tilePosition.row * tileSize,
                                tileSize,
                                tileSize
                            )
                        ...
                        function getTileCoordinates(absolutePosition) {
                            var textureNumber =
                                    (absolutePosition / tilesPerTexture) << 0,
                                localTileNumber =
                                    absolutePosition % tilesPerTexture,
                        ...
                        function markDirty() {
                            ...
                            if (skipedDirty > 10) {
                                ...
                                dirtyTimeoutId = window.setTimeout(
                                    markDirtyNow,
                                    400
                                )
                            }
                        ...
                        function copy(from, to) {
                            var fromCanvas =
                                    textures[from.textureNumber].canvas,
                ...
                function(require, module, exports) {
                    ...
                    function webglInputEvents(webglGraphics) {
                        ...
                        function getNodeAtClientPos(pos) {
                            return webglGraphics.getNodeAtClientPos(
                                pos,
                                preciseCheck
                            )
                        }
                        ...
                        function invoke(callbacksChain, args) {
                            ...
                            for (i = 0; i < callbacksChain.length; i += 1) {
                                stopPropagation = callbacksChain[i].apply(
                                    undefined,
                                    args
                                )
                                if (stopPropagation) {
                        ...
                        function startListen(root) {
                            ...
                            root.addEventListener('mousemove', function(e) {
                                ...
                                if (node && lastFound !== node) {
                                    ...
                                    cancelBubble =
                                        cancelBubble ||
                                        invoke(mouseEnterCallback, [lastFound])
                                } else if (
                                    node === null &&
                                    lastFound !== node
                                ) {
                        ...
                        var ATTRIBUTES_PER_PRIMITIVE = 6, // primitive is Line with two points. Each has x,y and color = 3 * 2 attributes.
                            BYTES_PER_LINK =
                                ...
                                (2 * Float32Array.BYTES_PER_ELEMENT +
                                    Uint32Array.BYTES_PER_ELEMENT), // two nodes * (x, y + color)
                            linksFS = [
                                'precision mediump float;',
                                'varying vec4 color;',
                                'void main(void) {',
                            ...
                            ensureEnoughStorage = function() {
                                ...
                                if (
                                    (linksCount + 1) * BYTES_PER_LINK >
                                    storage.byteLength
                                ) {
                                    // Every time we run out of space create new array twice bigger.
                                    // TODO: it seems buffer size is limited. Consider using multiple arrays for huge graphs
                                    var extendedStorage = new ArrayBuffer(
                                            storage.byteLength * 2
                                        ),
                                        extendedPositions = new Float32Array(
                                            extendedStorage
                                        ),
                                        extendedColors = new Uint32Array(
                                            extendedStorage
                                        )
                ...
                function(require, module, exports) {
                    ...
                    function webglNodeProgram() {
                        ...
                        function position(nodeUI, pos) {
                            ...
                            positions[
                                idx * ATTRIBUTES_PER_PRIMITIVE + 1
                            ] = -pos.y
                            positions[idx * ATTRIBUTES_PER_PRIMITIVE + 2] =
                                nodeUI.size

                            colors[idx * ATTRIBUTES_PER_PRIMITIVE + 3] =
                                nodeUI.color
                        }
